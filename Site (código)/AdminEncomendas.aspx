<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminEncomendas.aspx.cs" Inherits="Loja.AdminEncomendas" %>

<!DOCTYPE html >

<html xmlns="http://www.w3.org/1999/xhtml" style="background-image: linear-gradient(141deg, #1f191a 0%, #363636 71%, #46403f 100%)!important;background-repeat: no-repeat;">
<head runat="server">
...
<body>
    <form id="AdminEncomendas" runat="server">
       <!------------NAVBAR-------------------------->
        ...
        <section class="hero is-medium is-dark is-bold" style="font-family: 'Montserrat', sans-serif;">
             <div class="hero-body" style="text-align:center; padding-top:5em; height:100vh;">
                 <!--ULTIMAS ENCOMENDAS-->                   
                                    <h1 style="padding-left:0.8em; font-size:35px; font-weight:bold;margin-top:90px; font-family: 'Orbitron', sans-serif; color:white; text-align:center;">Encomendas:</h1><br /><br /><br />
                                        <table class="table" style="width:960px;">
                                    <br /><br />
                                          <thead>
                                            <tr>
                                              <th style="border-top-left-radius: 7px!important; ">ID</th>
                                              <th>Nome</th>
                                              <th>Data</th>
                                              <th>Valor</th>
                                              <th>Estado</th>
                                              <th style="border-top-right-radius: 7px!important; ">Ações</th>
                                                ...
                                                <tbody>
                                                     <asp:Label ID="listaEncomendas" runat="server" Text=""></asp:Label>
                                                </tbody>
                                    </table>
                  </div>     
         </section>
