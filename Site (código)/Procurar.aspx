<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Procurar.aspx.cs" Inherits="Loja.Procurar" %>
<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Gaming Lobby | Procura</title>
    <meta charset="utf-8" />
       ...
       <!--------------------------END-MENU------------------------------------------------------------------>
         <section class="hero is-medium is-dark is-bold" style="font-family: 'Montserrat', sans-serif;">
             <div class="hero-body" style="text-align:center; padding-top:5em;">
                ...
                <div style="text-align:center;" >
                    <h1 style="font-size:40px; font-weight:bold; font-family: 'Orbitron', sans-serif; color:white; text-align:center;">Procurou por:<asp:Label ID="procurou" runat="server" Text="Label"></asp:Label> </h1>
                </div>
             </div>      
         </section>
       <!--------------------------END-BANNER------------------------------------------------------------------>
