<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Homem.aspx.cs" Inherits="Loja.Homem" %>
<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Gaming Lobby | Homem</title>
    <meta charset="utf-8" />
       ...
       <!--------------------------END-MENU------------------------------------------------------------------>
         ...
         <section class="hero is-medium is-dark is-bold" style="font-family: 'Montserrat', sans-serif;">
             <div class="hero-body" style="text-align:center; padding-top:5em;">
                 <div class="tile is-parent" style="padding-left:30em; height:250px; padding-bottom:200px;">
                    <article class="tile notification is-danger is-bold is-8" style="margin-top: 80px;">
                        <figure class="image is-4by2" style="text-align:center;">
                            <img style="padding-left:0,7em; width:100%;" src="https://a.espncdn.com/combiner/i?img=%2Fphoto%2F2018%2F1026%2Fr453362_1296x729_16%2D9.jpg">
                        </figure>
                    </article>                 
                </div>
             </div>      
             <h1 style="font-size:40px; font-weight:bold; font-family: 'Orbitron', sans-serif; color:white; text-align:center;">Homem</h1><br /><br /><br />
         </section>
       <!--------------------------END-BANNER------------------------------------------------------------------>


        <section class="hero is-medium is-light is-bold" style="font-family: 'Montserrat', sans-serif;">
        <asp:Label ID="produtos"  runat="server"/>
           
            

        <span class="open" id="open" onclick="AbreFilter()" style=""><i class="fas fa-search-plus"></i> </span>

        <div class="filter" id="filter">
            <p style="text-align:center; font-size:25px; color:white; font-weight:bold;">Filtrar por:</p>
            <br /><br />
            <div style="text-align:center;">
            <asp:DropDownList ID="filtro" runat="server" AutoPostBack="true">
                <asp:ListItem Value="">Sem Filtro</asp:ListItem>
                <asp:ListItem Value="1">Preço Ascendente</asp:ListItem>
                <asp:ListItem Value="2">Preço Descendente</asp:ListItem>
                <asp:ListItem Value="3">Nome Ascendente</asp:ListItem>
                <asp:ListItem Value="4">Nome Descendente</asp:ListItem>
            </asp:DropDownList>
                </div>
        </div>
