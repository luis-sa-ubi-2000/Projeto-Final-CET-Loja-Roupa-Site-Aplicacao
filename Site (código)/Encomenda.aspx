<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Encomenda.aspx.cs" Inherits="Loja.Encomenda" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Gaming Lobby | Encomenda</title>
    <meta charset="utf-8" />
...
<body>
    <form id="form1" runat="server">
                                ...
                                <div class="columns is-mobile">
                                    <div class="column">
                                        <p class="bd-notification is-info" style="font-size:27px; font-weight:bold; font-family: 'Orbitron', sans-serif; color:black; margin-bottom:-20px;">
                                            Destinatário: <asp:Label ID="nomepessoa" runat="server" Text=""></asp:Label><br /><br />
                                            NIF: <asp:Label ID="nif" runat="server" Text=""></asp:Label><br /><br />
                                            Telefone:  <asp:Label ID="tel" runat="server" Text=""></asp:Label><br /><br />
                                            Morada: <asp:Label ID="morada" runat="server" Text=""></asp:Label><br /><br />
                                        </p>
                                    </div>
                                </div>
                        </div>
        ...
        <div class="column"><br /><br /><br />
            <div class="title"><h1 style="font-size:40px; font-weight:bold; font-family: 'Orbitron', sans-serif; color:#5F021F;">Produtos</h1></div>
            <div class="columns is-mobile">
                <div class="column ">
                    <table class="table" style="width:700px; margin-bottom:50px;">
                                          <thead>
                                            <tr>
                                              <th style="border-top-left-radius:8px;"></th>
                                              <th>Nome</th>
                                              <th>Quantidade</th>
                                              <th style="border-top-right-radius:8px;">Preço</th>
                                            </tr>
                                          </thead>
                                                <tbody>
                    ...
                    <h2 style="font-size:25px; font-weight:bold; font-family: 'Orbitron', sans-serif; color:#5F021F;">Valor: </h2>
                     <div style="font-size:20px; font-weight:bold; font-family: 'Orbitron', sans-serif; color:#5F021F;" ><asp:Label ID="valorsemdesconto" runat="server" Text="" ></asp:Label>&#8364;</div>
                     <h2 style="font-size:25px; font-weight:bold; font-family: 'Orbitron', sans-serif; color:#5F021F;">Valor Total c/ desconto: </h2>
                     <div style="font-size:20px; font-weight:bold; font-family: 'Orbitron', sans-serif; color:#5F021F;" ><asp:Label ID="total" runat="server" Text="0" ></asp:Label>&#8364;</div>
