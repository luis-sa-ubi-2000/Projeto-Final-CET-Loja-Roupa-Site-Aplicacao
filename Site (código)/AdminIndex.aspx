<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminIndex.aspx.cs" Inherits="Loja.AdminIndex" %>
...
<head runat="server">
    <title>ADMIN | Gaming Lobby</title>
    <meta charset="utf-8" />
        ...
        <section class="hero is-medium is-dark is-bold" style="font-family: 'Montserrat', sans-serif;">
             <div class="hero-body" style="text-align:center; padding-top:5em; height:100vh;">
                 <!--ULTIMAS ENCOMENDAS-->
                                    ...
                                    <h1 style="margin-top:90px; font-size:35px; font-weight:bold; font-family: 'Orbitron', sans-serif; color:white; text-align:center;">Últimas encomendas</h1><br /><br /><br />
                                <table class="table">
                                    <br /><br />
                                          <thead>
                                            <tr>
                                              ...
                                              <th>Nome</th>
                                              <th>Data</th>
                                              <th style="border-top-right-radius: 7px!important;">Valor</th>
                                            </tr>
                                          </thead>
                                                <tbody>
