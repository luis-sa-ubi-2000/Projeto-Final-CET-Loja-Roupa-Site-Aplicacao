<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminContas.aspx.cs" Inherits="Loja.AdminContas" %>
      ...
      <!------------NAVBAR-------------------------->
        ...
        <section class="hero is-medium is-dark is-bold" style="font-family: 'Montserrat', sans-serif;">
             <div class="hero-body" style="text-align:center; padding-top:5em; height:100vh;">
                 <!--ULTIMAS ENCOMENDAS-->                   
                                    <h1 style="padding-left:0.8em; margin-top:90px; font-size:35px; font-weight:bold; font-family: 'Orbitron', sans-serif; color:white; text-align:center;">Administração de Contas:</h1><br /><br /><br />
                                          ...
                                          <thead>
                                            <tr>
                                              ...
                                              <th style="border-top-right-radius: 7px!important;">Ações</th>
                                                ...
                                                <tbody>
                                                     <asp:Label ID="listaContas" runat="server" Text=""></asp:Label>
                                                </tbody>
                                    </table>
                  </div>     
         </section>
