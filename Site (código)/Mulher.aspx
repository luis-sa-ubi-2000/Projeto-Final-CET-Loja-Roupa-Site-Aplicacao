<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mulher.aspx.cs" Inherits="Loja.Mulher" %>
<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Gaming Lobby | Mulher</title>
    <meta charset="utf-8" />
                 ...
                 <div class="tile is-parent" style="padding-left:30em; height:250px; padding-bottom:200px;">
                    <article class="tile notification is-danger is-bold is-8" style="margin-top: 80px;">
                        <figure class="image is-4by2" style="text-align:center;">
                            <img style="padding-left:0,7em; width:100%;" src="../Imagens/girls.jpg" />
                        </figure>
                    </article>                 
                 </div>
             </div>      
             <h1 style="font-size:40px; font-weight:bold; font-family: 'Orbitron', sans-serif; color:white; text-align:center;">Mulher</h1><br /><br /><br />
         </section>
       <!--------------------------END-BANNER------------------------------------------------------------------>


        <section class="hero is-medium is-light is-bold" style="font-family: 'Montserrat', sans-serif;">
        <asp:Label ID="produtos" runat="server"></asp:Label>
            <span class="open" id="open" onclick="AbreFilter()" style="">&#9776; </span>
