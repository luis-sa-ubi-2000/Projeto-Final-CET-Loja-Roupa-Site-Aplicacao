<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Crianca.aspx.cs" Inherits="Loja.Crianca" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Gaming Lobby | Criança</title>
    <meta charset="utf-8" />
       ...
       <!--------------------------END-MENU------------------------------------------------------------------>
        ...
        <section class="hero is-medium is-dark is-bold" style="font-family: 'Montserrat', sans-serif;">
            <div class="hero-body" style="text-align:center; padding-top:5em;">
                  ...
                  <h1 style="font-size:40px; font-weight:bold; font-family: 'Orbitron', sans-serif; color:white; text-align:center;">Criança</h1><br /><br /><br />
            </div>
         </section>
        <!--------------------------END-BANNER------------------------------------------------------------------>
