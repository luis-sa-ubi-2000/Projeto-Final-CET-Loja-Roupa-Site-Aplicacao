<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminEditProduto.aspx.cs" Inherits="Loja.AdminEditProduto" %>
...
<head runat="server">
    <title>ADMIN | Edita Produto</title>
    <meta charset="utf-8" />
            ...
            <div class="hero-body">
                <div class="container">
                    <div class="columns">
                        ...
                        <br /><br /><br />
                            <div style="text-align:center; margin-top:-70px; margin-left:40px; width:600px; height:600px;"><asp:Label ID="imagemprod" runat="server" Text=""></asp:Label></div>
                        </div>

                        <div class="column admi">                   
                        Nome: <asp:TextBox ID="nome" runat="server"></asp:TextBox><br /><br />
                        Descrição: <asp:TextBox id="desc" TextMode="multiline" Columns="50" Rows="5" runat="server" Cssclass="textarea is-rounded"/><br />
                        Preço: <br /><asp:TextBox ID="preco" runat="server"></asp:TextBox>   &#8364;<br /><br />
                       ...
                       Imagem:<asp:FileUpload ID="imagem" runat="server" />
                        <asp:Button ID="edit" runat="server" Text="Editar" CssClass="button is-large is-danger"/><br /><br />
                         <asp:Button ID="apaga" runat="server" Text="Remover" CssClass="button is-large is-danger"/>
                    </div>
                </div>
            </div>
        </div>
