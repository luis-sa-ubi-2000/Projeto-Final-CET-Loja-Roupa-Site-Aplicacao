<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminNewsletter.aspx.cs" Inherits="Loja.AdminNewsletter" %>
...
<head runat="server">
   <title>ADMIN | Enviar Newsletter</title>
     <meta charset="utf-8" />
       ...
       <!------------NAVBAR-------------------------->
        ...
        <section class="hero is-medium is-dark is-bold" style="font-family: 'Montserrat', sans-serif;">
            <div class="hero-body" style="text-align:center; padding-top:5em; height:100vh;">
                <h1 style=" font-size:35px; margin-top:90px; font-weight:bold; font-family: 'Orbitron', sans-serif; color:white; text-align:center;">Envio de Newsletter:</h1><br /><br />
                    <h1 style=" font-size:25px; margin-top:90px; font-weight:bold; font-family: 'Orbitron', sans-serif; color:white; text-align:center;">Assunto:</h1>
                        <asp:TextBox ID="titulo" CssClass="nopadd" runat="server"></asp:TextBox><br /><br />

                        <h1 style=" font-size:25px; margin-top:90px; font-weight:bold; font-family: 'Orbitron', sans-serif; color:white; text-align:center;">Corpo:</h1>                     
                        <asp:TextBox ID="corpo" TextMode="MultiLine" CssClass="nopadd"  Columns="80" Rows="15" runat="server"></asp:TextBox><br /><br /><br />

                 <asp:Button ID="enviarbutton" runat="server" Text="Enviar" Height="45px"  CssClass="button is-danger is-large" />
             </div>     
         </section>
        <!-------------------------------------------------------------------------------->
    </form>
